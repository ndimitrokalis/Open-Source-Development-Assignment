/* =============================================================================
   update_article.js — handles the article edit form submission.
   Sends PUT /articles/<id> (JSON) and redirects to the articles list on success.
   ============================================================================= */
...
const ARTICLE_ID = parseInt(form.dataset.articleId, 10);
...
form.addEventListener('submit', async (e) => {
  ...
  const payload = { title, type, content };
  ...
  try {
    ...
    if (res.ok) {
      showAlert('Article updated! Redirecting…', 'success');
